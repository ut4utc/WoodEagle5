                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab1">
                            ...
                            <ul class="dl-horizontal">
                                <li> <?php echo JText::_('COM_KUNENA_MENU_TOPIC'); ?> : <?php echo $this->topic->displayField('subject'); ?> </li>
                                <li> <?php echo JText::_('COM_KUNENA_CATEGORY'); ?> : <?php echo $this->category->displayField('name') ?> </li>
                                <?php if (isset($this->userLink)) : ?>
                                    <li> <?php echo JText::_('JGLOBAL_USERNAME'); ?> : <strong><?php echo $this->userLink; ?></strong></li>
                                <?php endif; ?>
                            </ul>
                            ...
                            <?php if (isset($this->message)) : ?>
                                ...
                                <div class="kmoderate-message">
                                    ...
                                    <div class="kmessage-avatar"><?php echo $this->message->getAuthor()->getAvatarImage('img-thumbnail', 'list'); ?></div>
                                    <div class="kmessage-msgtext"><?php echo $this->message->displayField('message'); ?></div>
                                </div>
                            <?php endif; ?>
                        </div>
                        ...
                        <div class="control-group center">
                            <input type="submit" class="kbutton"
                                   value="<?php echo JText::_('COM_KUNENA_POST_MODERATION_PROCEED'); ?>" style="margin: 0"/>
                            <a href="javascript:window.history.back();" class="kbutton"> <?php echo JText::_('COM_KUNENA_BACK'); ?> </a>
                        </div>
                    </div>
                </div>
            </form>
